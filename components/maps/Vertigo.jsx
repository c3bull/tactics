                ...
                <View style={{display: "flex", justifyContent: "center", alignItems: "center"}}>
                    ...
                    {allVertigoTactics.map((tactic, key) => (
                            tactic.includes("attacking_site_tactic_") ?
                                <View key={key}>
                                    {showTSiteTactics &&
                                        <VertigoTactic tactic={tactic} refresh={setRefresh} tacticSite="tSite"/>}
                                </View> :
                                <View key={key}>
                                    {showCTSiteTactics &&
                                        <VertigoTactic tactic={tactic} refresh={setRefresh} tacticSite="ctSite"/>}
                                </View>
                        )
                    )}
                </View>
                ...
                <View style={{paddingTop: 25, paddingHorizontal: 15, width: '100%'}}>
                    ...
                    {noTactics && (
                        <View style={styles.noTactics}>
                            <Text style={{color: "#FFF", fontSize: 22, textTransform: 'uppercase', fontFamily: "PoppinsRegular",
                                textAlign: "center"}}>
                                You don't have any vertigo tactics yet</Text>
